...
from diffusion.gbm_process import simulated_gbm_pointwise
from backtesting.backtesting import backtest_i
...
def generate_critical_values_gbm(df, equity, dict_bt, dict_cal, scenario_amount=200):
    ...
    for el in range(scenario_amount):
        ...
        df_bootstrapped = simulated_gbm_pointwise(initialValue, date_grid, nPaths, params[equity])
        ...
        p_list = backtest_i(df_bootstrapped,
